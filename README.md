...
- **[The Second Challenge on Cross-Domain Few-Shot Object Detection at NTIRE 2026: Methods and Results](https://arxiv.org/abs/2604.11998).**
  - <img src="https://img.shields.io/badge/CVPRW%202026-red" alt="CVPRW" height="20">  [Object Detection]  <a href="https://github.com/ohMargin/NTIRE2026_CDFSOD"><img src="https://img.shields.io/github/stars/ohMargin/NTIRE2026_CDFSOD.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[FSOD-VFM: Few-Shot Object Detection with Vision Foundation Models and Graph Diffusion](https://arxiv.org/pdf/2602.03137).**
  - <img src="https://img.shields.io/badge/ICLR%202026-orange" alt="ICLR" height="20">  [Object Detection]  <a href="https://intellindust-ai-lab.github.io/projects/FSOD-VFM"><img src="https://img.shields.io/github/stars/Intellindust-AI-Lab/FSOD-VFM.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Less is Better: Sparse Instance Learning for Cross-Domain Few-Shot Object Detection](https://ojs.aaai.org/index.php/AAAI/article/view/37432).**
  - <img src="https://img.shields.io/badge/AAAI%202026-green" alt="AAAI" height="20">  [Object Detection]  <a href="https://github.com/johnmaijer/LessIsBetter"><img src="https://img.shields.io/github/stars/johnmaijer/LessIsBetter.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Intra-Image Mining and Symmetric Maximum Concept Matching for Few Shot Out-of-Distribution Detection](https://ojs.aaai.org/index.php/AAAI/article/view/37280).**
  - <img src="https://img.shields.io/badge/AAAI%202026-green" alt="AAAI" height="20">  [OOD Detection]  <a href="https://github.com/pSGAme/IIM-SMCM"><img src="https://img.shields.io/github/stars/pSGAme/IIM-SMCM.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[StyleProto: Style-Augmented Prototype Learning for Cross-Domain Few-Shot Object Detection](https://dblp.org/rec/conf/aaai/YangX26.html).**
  - <img src="https://img.shields.io/badge/AAAI%202026-green" alt="AAAI" height="20">  [Object Detection]  <a href="https://github.com/Wildfire-det/StyleProto"><img src="https://img.shields.io/github/stars/Wildfire-det/StyleProto.svg?style=social&label=Star" alt="Star" height="20"></a>
  - *Xi Yang, Quantao Xie.*
- **[Remedying Target-Domain Astigmatism for Cross-Domain Few-Shot Object Detection](https://arxiv.org/abs/2603.18541).**
  - <img src="https://img.shields.io/badge/CVPR%202026-red" alt="CVPR" height="20">  [Object Detection]
...
- **[A Closer Look at Cross-Domain Few-Shot Object Detection: Fine-Tuning Matters and Parallel Decoder Helps](https://arxiv.org/abs/2603.28182).**
  - <img src="https://img.shields.io/badge/CVPR%202026-red" alt="CVPR" height="20">  [Object Detection]  <a href="https://github.com/Intellindust-AI-Lab/FT-FSOD"><img src="https://img.shields.io/github/stars/Intellindust-AI-Lab/FT-FSOD.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[INSID3: Training-Free In-Context Segmentation with DINOv3 (Oral)](https://arxiv.org/abs/2603.28480).**
  - <img src="https://img.shields.io/badge/CVPR%202026-red" alt="CVPR" height="20">  [Object Detection]  <a href="https://github.com/visinf/INSID3"><img src="https://img.shields.io/github/stars/visinf/INSID3.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Language Does Matter for Cross-Domain Few-Shot Visual Feature Enhancement](https://openaccess.thecvf.com//content/CVPR2026/papers/Zhou_Language_Does_Matter_for_Cross-Domain_Few-Shot_Visual_Feature_Enhancement_CVPR_2026_paper.pdf).**
  - <img src="https://img.shields.io/badge/CVPR%202026-red" alt="CVPR" height="20">  [Classification, Object Detection, Segmentation]  <a href="https://github.com/SivanXT/LDM-CDFSL"><img src="https://img.shields.io/github/stars/SivanXT/LDM-CDFSL.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[AgentDet: A Shared-Blackboard Multi-Agent Framework for Zero-/Few-Shot Object Detection](https://openaccess.thecvf.com//content/CVPR2026/papers/Li_AgentDet_A_Shared-Blackboard_Multi-Agent_Framework_for_Zero-Few-Shot_Object_Detection_CVPR_2026_paper.pdf).**
  - <img src="https://img.shields.io/badge/CVPR%202026-red" alt="CVPR" height="20">  [Agent, Object Detection]
...
- **[Pointing at Parts: Training-Free Few-Shot Grounding in Multimodal LLMs](https://openaccess.thecvf.com/content/CVPR2026/papers/Tsai_Pointing_at_Parts_Training-Free_Few-Shot_Grounding_in_Multimodal_LLMs_CVPR_2026_paper.pdf).**
  - <img src="https://img.shields.io/badge/CVPR%202026-red" alt="CVPR" height="20">  [Grounding, MLLM]
...
- **[DetPO: In-Context Learning with Multi-Modal LLMs for Few-Shot Object Detection](https://arxiv.org/abs/2603.23455).**
  - <img src="https://img.shields.io/badge/ECCV%202026-purple" alt="ECCV" height="20">  [In-Context, Object Detection]  <a href="https://github.com/ggare-cmu/DetPO"><img src="https://img.shields.io/github/stars/ggare-cmu/DetPO.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[FOCUS: Forcing In-Context Object Localization through Visual Support Constraints and Policy Optimization](https://arxiv.org/abs/2605.31145).**
  - <img src="https://img.shields.io/badge/ICML%202026-teal" alt="ICML" height="20">  [In-Context, Object Localization]
...
- **[Reviving In-domain Fine-tuning Methods for Source-Free Cross-domain Few-shot Learning](https://arxiv.org/pdf/2605.11659).**
  - <img src="https://img.shields.io/badge/arXiv%202026-b31b1b" alt="arXiv" height="20">  [Classification]
...
- **[PrAda: Few-Shot Visual Adaptation for Text-Prompted Segmentation](https://arxiv.org/abs/2605.19623).**
  - <img src="https://img.shields.io/badge/CVPR%202026%20Findings-red" alt="CVPR" height="20">  [Visual Prompt, Segmentation]  <a href="https://github.com/FocoosAI/PrAda"><img src="https://img.shields.io/github/stars/FocoosAI/PrAda.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Learning Multi-Modal Prototypes for Cross-Domain Few-Shot Object Detection](https://arxiv.org/abs/2602.18811).**
  - <img src="https://img.shields.io/badge/CVPR%202026%20Findings-red" alt="CVPR" height="20">  [Object Detection]
...
- **[GiPL: Generative Augmented Iterative Pseudo-Labeling for Cross-Domain Few-Shot Object Detection](https://arxiv.org/abs/2605.29539).**
  - <img src="https://img.shields.io/badge/arXiv%202026-b31b1b" alt="arXiv" height="20">  [Object Detection]  <a href="https://github.com/z-yaz/CDiscover"><img src="https://img.shields.io/github/stars/z-yaz/CDiscover.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Rethinking Prototype-based Similarity Learning for Few-Shot Object Detection](https://arxiv.org/abs/2606.23069).**
  - <img src="https://img.shields.io/badge/ECCV%202026-purple" alt="ECCV" height="20">  [Object Detection]  <a href="https://github.com/VisualScienceLab-KHU/ReSet"><img src="https://img.shields.io/github/stars/VisualScienceLab-KHU/ReSet.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[GP-Adapter: Gaussian Process CLIP-Adapter for Few-Shot Out-of-Distribution Detection](https://arxiv.org/abs/2606.07102).**
  - <img src="https://img.shields.io/badge/IJCNN%202026-blue" alt="IJCNN" height="20">  [OOD Detection]  <a href="https://github.com/tms-byte/GP-Adapter"><img src="https://img.shields.io/github/stars/tms-byte/GP-Adapter.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Training-free Cross-domain Few-shot Segmentation via Robust Semantic Representation and Matching](https://arxiv.org/abs/2606.24297).**
  - <img src="https://img.shields.io/badge/ECCV%202026-purple" alt="ECCV" height="20">  [Segmentation]  <a href="https://github.com/Sparkling-Water/RSRM"><img src="https://img.shields.io/github/stars/Sparkling-Water/RSRM.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Personalized Object Identification and Localization via In-Context Inference with Vision-Language Models](https://arxiv.org/abs/2607.00357).**
  - <img src="https://img.shields.io/badge/arXiv%202026-b31b1b" alt="arXiv" height="20">  [Object Detection, VLM]
...
- **[Training-Free Open-Vocabulary 3D Point-Cloud Segmentation on the Generalized Few-Shot Benchmark](https://arxiv.org/abs/2607.15331).**
  - <img src="https://img.shields.io/badge/arXiv%202026-b31b1b" alt="arXiv" height="20">  [3D Point-Cloud Segmentation, Few-Shot]
...
- **[Few-Shot Open-Vocabulary Remote Sensing Segmentation via Textual Inversion](https://arxiv.org/abs/2607.25563).**
  - <img src="https://img.shields.io/badge/arXiv%202026-b31b1b" alt="arXiv" height="20">  [Remote Sensing, Segmentation]  <a href="https://github.com/ROKMC1250/FewShot-OVRS-TI"><img src="https://img.shields.io/github/stars/ROKMC1250/FewShot-OVRS-TI.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Free-Lunch Augmentation by Revisiting Diffusion-Based Data Generation for Cross-Domain Few-Shot Object Detection](https://arxiv.org/pdf/2608.04394).**
  - <img src="https://img.shields.io/badge/ECCV%202026-purple" alt="ECCV" height="20">  [Object Detection]  <a href="https://github.com/zzzzj311-droid/Free-Lunch-SITN"><img src="https://img.shields.io/github/stars/zzzzj311-droid/Free-Lunch-SITN.svg?style=social&label=Star" alt="Star" height="20"></a>
...
- **[Hierarchical Spatial and Channel Aggregation for Cross-domain Few-shot Segmentation](https://arxiv.org/abs/2606.24296).**
  - <img src="https://img.shields.io/badge/ECCV%202026-purple" alt="ECCV" height="20">  [Segmentation]
  - *Sujun Sun, Mingwu Ren, Haofeng Zhang.*
- **[Unlocking Few-Shot Capabilities in LVLMs via Prompt Conditioning and Head Selection](https://arxiv.org/pdf/2603.24181).**
  - <img src="https://img.shields.io/badge/ECCV%202026-purple" alt="ECCV" height="20">  [Classification, LVLM]  <a href="https://github.com/AdhemarDeSenneville/HEC"><img src="https://img.shields.io/github/stars/AdhemarDeSenneville/HEC.svg?style=social&label=Star" alt="Star" height="20"></a>
